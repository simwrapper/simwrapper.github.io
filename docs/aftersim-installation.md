...
- If you are only interested in using aftersim at aftersim.github.io (in other words, if you are at VSP Berlin and want to view model results), then you do not need to do this. (Read [these instructions](/docs/docs/aftersim-intro) instead)
